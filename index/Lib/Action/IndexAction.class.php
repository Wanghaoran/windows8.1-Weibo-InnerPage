...
//        $id = !empty($_GET['tid']) ? $this -> _get('tid', 'intval') : 1;
    ...
    public function part2(){
        ...
        $result = $WeiboShareList -> field('content,reposts_count,user_screen_name,user_profile_image_url,user_description,mid,uid') -> where('isshow=1') -> order('created_at DESC') -> select();
        $this -> assign('result', $result);
        $this -> display();
    }
